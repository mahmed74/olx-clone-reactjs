...
class AppAfterLogin extends React.Component{
    render(){
        return(
...
export class HeaderAfterLogin extends React.Component{
    render(){
        return(
        ...
        <div className="collapse navbar-collapse navbarSearchmainDiv" id="navbarNav">
           ...
           <Searchbar/><button className="Searchbtn"><SearchOutlinedIcon/></button><div className="BtnsDiv">  <div className="SellBtn">
