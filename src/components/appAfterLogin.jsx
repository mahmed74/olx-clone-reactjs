...
//            <Searchbar/><button className="Searchbtn"><SearchOutlinedIcon/></button><div className="BtnsDiv"> <div className="Avatar"><Avatar src={user.photo} /></div> <div className="SellBtn">
